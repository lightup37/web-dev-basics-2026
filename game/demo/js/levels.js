...
var LEVELS_ORDER = [
	...
	},
	{
		...
		hint: '指令：这是最后一场攻坚战——敌守军 8 人占据右侧高地、原地固守不追不逃。时限 17 回合：回合耗尽即判负。情报：要按时全歼守军，就必须顶着火力压上去集火——但冲得越猛、伤亡越大。星级按过关时使用的步数算(使用少于13回合=3星;使用少于15回合=2星;使用少于17回合=1星)；想满星就先把殿后的大炮拔掉，别让高伤单位白白送命。',
		story: [
			{ who: '拿破仑', text: '天亮之前，必须拿下那座高地。对面的守军一步也不会退。' },
			{ who: '副官', text: '陛下，十七个回合——够我们把大炮推上前线吗？' },
